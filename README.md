...
# 2. 安装 Isaac Gym Preview 4 (https://developer.nvidia.com/isaac-gym)
...
**训练时间参考：**
- 500 iteration：机器人可能还站不稳
- 1000 iteration：能站稳但走得不好
- 1500 iteration：能基本走起来
- 2000 iteration（默认）：比较好的效果
